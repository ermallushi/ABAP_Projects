...
*
*  Some modifications by Optimyth Software (http://www.kiuwan.com)
*  version 1.5.5.1
*     - remove footer for extracted files.
*     - change file extension to .abap.
*
*
*----------------------------------------------------------------------------------------------------------------------
...
constants: TEXTEXTENSION type string value 'abap'.
...
*----------------------------------------------------------------------------------
* Extracted by Mass Download version 1.5.5 - E.G.Mellodew. 1998-2015. Sap Release 731
